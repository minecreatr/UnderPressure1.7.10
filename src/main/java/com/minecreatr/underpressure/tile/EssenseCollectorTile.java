...
//            else if (worldObj.getClosestPlayer(xCoord, yCoord, zCoord, 5)!=null) {
//                worldObj.getClosestPlayer(xCoord, yCoord, zCoord, 5).addChatMessage(new ChatComponentText("Null Portals"));
//            }
        }
    }

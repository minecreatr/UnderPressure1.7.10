...
//                if (worldObj.getClosestPlayer(x, y, z, 5)!=null){
//                    worldObj.getClosestPlayer(x, y, z, 5).addChatMessage(new ChatComponentText("XD: "+Math.abs(cur.x-x)+" YD: "+Math.abs(cur.y-y)+" ZD: "+Math.abs(cur.z-z)));
//                }
